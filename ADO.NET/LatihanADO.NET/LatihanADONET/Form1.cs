...
namespace LatihanADONET
{
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"C:\22.11.5209\Pemro-C-Sharp\ADO.NET\LatihanADO.NET\Database\DbPerpustakaan.db";
                // deklarasi variabel connectionString, ref: https://www.connectionstrings.com/
                string connectionString = string.Format("DataSource={0};FailIfMissing=True",
                    dbName);
 ...
 where npm = @npm";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Apakah mau di apus?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
